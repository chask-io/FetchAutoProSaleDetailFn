# FetchAutoProSaleDetailFn

Extrae en modo solo lectura el detalle completo de una venta AutoPro por folio
para Daniel Achondo, preservando campos crudos del wizard y comentario.
...
- **Timeout**: 600s
- **Memory**: 1024MB
- **Layers**: foundationMinimal, foundationApi, custom/browserbase_layer

## Parameters

### Required

- **node_id** (string): Node ID for widget configuration injection
- **folio** (string): Folio AutoPro a consultar. Primer hito autorizado: 7954.
...
selector and click calls pass through a read-only guard that rejects unsafe
...
- The function name matches "FetchAutoProSaleDetailFn"
...
- AWS CloudWatch Logs: `/aws/lambda/FetchAutoProSaleDetailFn`
- Chask dashboard: Organization → Functions → FetchAutoProSaleDetailFn
