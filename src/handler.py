...
FetchAutoProSaleDetailFn - Lambda Handler

Extrae en modo solo lectura el detalle completo de una venta AutoPro por folio para Daniel Achondo, preservando campos crudos del wizard y comentario.
